...
#----------------------------------------------------------------------------------------------
Test_10 <- read.csv("E:/Milind/Data Science/Project_Incident Prediction/Final Submission/Revised/test_top5.csv")

#----------------------------------------------------------------------------------------------
#************************* Define UI for app **************************************

ui <- dashboardPage(skin = "blue",
                    dashboardHeader(title = "Team-5 Incident Impact Analysis",titleWidth = 350),
...
server <- function(input, output) {
    ...
    output$modelSummary <- renderPrint({
        req(input$file1)
        df <- read.csv(input$file1$datapath)
        model <- load(file = "E:/Milind/Data Science/Project_Incident Prediction/Final Submission/Revised/rf_up_1.R")
        pred_data <- df[,1:6]
    ...
    observeEvent(input$go,
                 {
                     ...
                     output$img <- renderImage({
                         ...
                         if(dt == "1 - High"){
                             list(src ="E:/Milind/Data Science/Project_Incident Prediction/Final Submission/Revised/high.jpg",
                                  width = 250,height = 150)
                         } 
                         
                         else if(dt == "2 - Medium"){
                             list(src ="E:/Milind/Data Science/Project_Incident Prediction/Final Submission/Revised/medium.jpg",
                                  width = 250,height = 150)
                         }
                         
                         else {
                             list(src ="E:/Milind/Data Science/Project_Incident Prediction/Final Submission/Revised/low.jpg",
                                  width = 250,height = 150)
                         }
                     },deleteFile = FALSE)
   }
